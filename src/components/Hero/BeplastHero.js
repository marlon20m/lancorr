...
function BeplastHero() {
  return (
      <>
    <section class="hero is-small is-large-mobile "> 
      <div class="hero-body"> 
        <div class="container has-text-left"> 
        <h1 class="title has-text-white has-text-centered has-text-weight-bold title-text-ah is-size-1 is-size-3-mobile is-uppercase">
        Beplast
      </h1>
        </div> 
      </div> 
